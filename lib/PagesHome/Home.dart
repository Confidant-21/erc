            ...
            SliverAppBar(
              ...
              title: Row(
                ...
                children: [
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: Icon(Icons.pending_rounded,color:Color(0xFFF1F1E6),),
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xFF04356D),
                        shape: RoundedRectangleBorder(
                            borderRadius:
                                BorderRadius.all(Radius.circular(20)))),
                    label: Text('Setting',style: TextStyle(color: Color(0xFFF1F1E6)),),
                  ),
                  ElevatedButton.icon(
                    onPressed: () {},
                    icon: Icon(Icons.add_photo_alternate_rounded,color:Color(0xFFF1F1E6),),
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xFF04356D),
                        shape: RoundedRectangleBorder(
                            borderRadius:
                                BorderRadius.all(Radius.circular(20)))),
                    label: Text('Add Post',style: TextStyle(color: Color(0xFFF1F1E6)),),
                  ),
                ],
              ),
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: Image.asset("assets/Images/Feed/1.png",
